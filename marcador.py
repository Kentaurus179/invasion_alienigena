...
class Marcador():
    ...
    def __init__(self, ai_configuraciones, pantalla, estadisticas):
        """inicializa los atributos de registro de puntaje"""
    ...
    def prep_puntaje(self):
        ...
        #muestra el puntaje en la esquina superior derecha en la pantalla
    ...
    def prep_alto_puntaje(self):
        ...
        #muestra el puntaje mas alto en la esquina superior de la pantalla
